...
namespace Wallety.Portal.Application.Mapper
{
    public class ConfigureMappingProfile : Profile
    {
        public ConfigureMappingProfile()
        {
            ...
            // Transaction History
            CreateMap<Pagination<TransactionHistoryEntity>, Pagination<TransactionHistoryReponse>>().ReverseMap();
            CreateMap<DataList<TransactionHistoryEntity>, DataList<TransactionHistoryReponse>>().ReverseMap();
